...
## 7.[路径总和 III](https://leetcode-cn.com/problems/path-sum-iii/)
...
## 8. [另一个树的子树](https://leetcode-cn.com/problems/subtree-of-another-tree/)
...
## 12. [最长同值路径](https://leetcode-cn.com/problems/longest-univalue-path/)
...
## 13. [打家劫舍 III](https://leetcode-cn.com/problems/house-robber-iii/)
...
## 1. [二叉树的层平均值](https://leetcode-cn.com/problems/average-of-levels-in-binary-tree/)
...
给定一个二叉搜索树，编写一个函数 kthSmallest 来查找其中第 k 个最小的元素。说明：
...
## 6.[将有序数组转换为二叉搜索树](https://leetcode-cn.com/problems/convert-sorted-array-to-binary-search-tree/)
